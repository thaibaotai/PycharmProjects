...
class Animals:
    kind = 'pets'  # Add a class variable `kind` and assign it the required value.

    def __init__(self, name, species):
        self.name = name  # Add an instance variable `name`.
        pass
        self.species = species  # Add an instance variable `species`.
